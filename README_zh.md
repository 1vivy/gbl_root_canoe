...
7.0.0-b5 的发布界面是桌面与 KernelSU WebUI 共用的一个应用；原生工作进程也供 KSU 安装器使用，负责审阅、

b5 正在重构为浏览器 WASM/USB 应用和 KSU 原生工作进程。桌面安装包及文件系统辅助进程已退役；b4-final 标签保留旧版本。下方旧桌面打包说明属于历史资料。
