...
In 7.0.0-b4 the boot policy is explicit. Global keys must appear before the first `entry`:
...
The 7.0.0-b4 writer manages a loader and its two matching sidecars for each installed slot.
