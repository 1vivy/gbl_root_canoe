...
In 7.0.0-b5 the boot policy is explicit. Global keys must appear before the first `entry`:
...
The 7.0.0-b5 writer manages a loader and its two matching sidecars for each installed slot.
