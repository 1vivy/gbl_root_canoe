...
for (const [index, fixture] of goldens.entries()) {
  ...
  if (fixture.optional_external_fixture && !existsSync(path)) { skipped++; console.log(`SKIP optional external ${fixture.source}`); continue; }
...
console.log(`WASM actual runtime matches ${passed} native CLI goldens (${skipped} optional inputs absent); canonical config/BLS pass; zero runtime imports; memory ${api.memory.buffer.byteLength} bytes.`);
